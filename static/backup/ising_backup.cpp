...
int main(){
	...
	ofstream ans ("static_dataN2.txt");
...
for (double beta=1.0; beta>0.1; beta-=0.01){
	...
	for(int T=0;T<1000000000000; T++){
		...
		for (int i=0;i<5000;i++){
				...
				if(fabs(lowE-midE)/5000.0<0.005&&fabs(higE-midE)/5000.0<0.005 && c >500){break;}else{c++;}
